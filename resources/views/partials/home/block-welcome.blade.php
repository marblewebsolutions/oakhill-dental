<div class="block-content">
    ...
    <div class="show-on-desktop">
        <div class="split-2 staff-photo">
            ...
            <p class="mt-med">Oakhill Dental is committed to excellence, compassion, and building 
            ...
            <a class="mt-med btn full-width primary" href="{{ asset('pdf/Oakhill-March-Newsletter.pdf') }}" target="_blank">SEE NEWSLETTER</a>
        </div>
    </div>
    
    <div class="show-on-mobile">
        <p class="mt-lg border-left">We hope you explore our site to learn about our practice.<br><br> 
        We believe that informed patients are the most successful in their journey to a healthy smile.<br><br>
        We are here to assist you in that journey.</p>
        
        <div class="box mt-lg">
            <p>Your questions are welcome!<br> 
            Give us a call or stop by our office:<br>
            <span class="bold">@include('partials.links.address')</span></p>
        </div>
        
        <img class="mt-lg staff-photo" src="{{ asset('images/staffphoto.png') }}" alt="Staff Photo">
        
        <p class="mt-lg">Oakhill Dental is committed to excellence, compassion, and building 
        lifelong relationships with our patient family.</p>
        
        <p class="mt-med">Oral care is an important part of your overall wellness we provide a full 
        range of dental services to help you achieve your optimal health.</p>
        
        <p class="mt-med">These services include preventive, cosmetic and restorative dentistry 
        as well as treatment of snoring and sleep apnea with dental appliance therapy.</p>
        
        <a class="mt-lg btn primary full-width" href="{{ asset('pdf/Oakhill-March-Newsletter.pdf') }}" target="_blank">SEE NEWSLETTER</a>
    </div>
</div>